...
# Kümelenme izlemede ("gainer" cüzdanları yeni ne alıyor?) gürültü sayılıp
# dışlanan köklü mint'ler — bunlar "yeni bir token'a birlikte giriyorlar"
# sinyalinin aradığı şey değil.
WELL_KNOWN_MINTS = {
